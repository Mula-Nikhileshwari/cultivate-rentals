...
<?php 
    ...
    $sql2="select *from equipments where AVAILABLE='Y'";
    $equip= mysqli_query($con,$sql2);
    
    // $row=mysqli_fetch_assoc($equipments);
...
?>
  ...
  <div class="cd">
    <div class="main">
      ...
      <div><h1 class="overview">OUR Equipments OVERVIEW</h1>
    ...
    $name = mysqli_query($con,$sql);
    $rows=mysqli_fetch_assoc($name);
    // $sql2="select *from equipments where EQUIP_ID=1";
    // $equipments= mysqli_query($con,"select *from equipments where EQUIP_ID=1");
