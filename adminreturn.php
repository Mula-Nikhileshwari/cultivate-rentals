...
if($res['AVAILABLE']=='Y')
{
    echo '<script>alert("ALREADY Equipment IS RETURNED")</script>';
    echo '<script> window.location.href = "adminbook.php";</script>';
}
else{
    
    $sql4="UPDATE equipments set AVAILABLE='Y' where EQUIP_ID=$res[EQUIP_ID]";
    ...
    echo '<script>alert("Equipment RETURNED SUCCESSFULLY")</script>';
    echo '<script> window.location.href = "adminbook.php";</script>';
}  
