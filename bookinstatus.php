...
<?php
    ...
    if($rows==null){
        ...
        echo '<script> window.location.href = "equipdetails.php";</script>';
    }
    else{
    $sql2="select * from users where EMAIL='$email'";
    $name2 = mysqli_query($con,$sql2);
    $rows2=mysqli_fetch_assoc($name2);
    $equip_id=$rows['EQUIP_ID'];
    $sql3="select * from equipments where EQUIP_ID='$equip_id'";
...
?>
   <ul><li> <button  class="utton"><a href="equipdetails.php">Go to Home</a></button></li><li class="name">HELLO! <?php echo $rows2['FNAME']." ".$rows2['LNAME']?></li>
    ...
    <div class="box">
         <div class="content">
             <h1>EQUIPMENT NAME : <?php echo $rows3['EQUIP_NAME']?></h1><br>
