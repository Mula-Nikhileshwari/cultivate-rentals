    ...
    if(isset($_POST['login']))
    {
        ...
        if(empty($email)|| empty($pass))
        {
            ...
            if($row=mysqli_fetch_assoc($res)){
                ...
                {
                    header("location: equipdetails.php");
                    session_start();
...
?>
    <div class="hai">
        ...
        <div class="content">
            <h1>Rent Your <br><span>Farmer Equipments</span></h1>
            <p class="par">Live the life of Farming.<br>
                Just rent a Farmer EQUIPMENT of your wish from our vast collection.<br>
