...
<body  background=images/bookingb.jpg>
<style>
*{
    margin: 0;
    padding: 0;
...
<?php 
    ...
    $sql="select *from equipments where EQUIP_ID='$equipid'";
    ...
    if(isset($_POST['book'])){
        ...
        if(empty($bplace)|| empty($bdate)|| empty($dur)|| empty($phno)|| empty($des)|| empty($rdate)){
            ...
            $sql="insert into booking (EQUIP_ID,EMAIL,BOOK_PLACE,BOOK_DATE,DURATION,PHONE_NUMBER,DESTINATION,PRICE,RETURN_DATE) values($equipid,'$uemail','$bplace','$bdate',$dur,$phno,'$des',$price,'$rdate')";
       ...
       <div class="hai">
            <div class="navbar">
                ...
                <div class="menu" >
                    <ul>
                        <li></li>
                        <li ><a href="equipdetails.php">HOME</a></li>
        ...
        <form id="register" method="POST"  >
            <h2>EQUIPMENT NAME : <?php echo "".$email['EQUIP_NAME']?></h2>
