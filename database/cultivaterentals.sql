...
('Aashlesha@gmail.com', 'Aashlesha', 'Wagh', 'B2343', 9845687555, 'c788b480e4a3c807a14b6f3f4b1a1ae6', 'male'),
( 'Aditya@gmail.com','Aditya', 'Wagh', 'ghhdhd', 6363549133, 'e6235c884414e320c8781c22b0c38c9b', 'male'),
('Pradnya@gmail.com','Pradnya', 'Wagh',  'B3uudh4', 6363549133, 'e6235c884414e320c8781c22b0c38c9b', 'male');
...
INSERT INTO `equipments` (`EQUIP_ID`, `EQUIP_NAME`, `FUEL_TYPE`, `CAPACITY`, `PRICE`, `EQUIP_IMG`, `AVAILABLE`) VALUES
(1, 'Mattock', 'No fuel', 5, 300, 'Mattock2.webp', 'Y'),
(2, 'Fertilizer pump', 'Petrol', 6, 700, 'sprinkler.jpg', 'Y'),
(3, 'Rake', 'No fuel', 4, 400, 'rake2.jpg', 'Y'),
(20, 'Shovel', 'No fuel', 22, 250, 'shovel.jpg', 'Y'),
(4, 'Wheel Barrow', 'No fuel', 5, 1500, 'wheelbarrow.jpg', 'Y'),
(5, 'spade', 'No fuel', 5, 2500, 'spade.jpg', 'Y');
...
INSERT INTO `booking` (`BOOK_ID`, `EQUIP_ID`, `EMAIL`, `BOOK_PLACE`, `BOOK_DATE`, `DURATION`, `PHONE_NUMBER`, `DESTINATION`, `RETURN_DATE`, `PRICE`, `BOOK_STATUS`) VALUES
...
(10, 'abc@gmail.com', 'hai I am satisfied with your service \r\n');
...
--
ALTER TABLE `booking`
  ADD CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`EQUIP_ID`) REFERENCES `equipments` (`EQUIP_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
